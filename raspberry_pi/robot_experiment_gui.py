...
<div class="card"><h2>3. RPM 자동 시험</h2><p class="muted">바퀴를 띄우세요. 0.10, 0.15, 0.20을 자동 측정합니다.</p><div class="row"><button onclick="start({type:'rpm',robot:0})">Robot 1</button><button onclick="start({type:'rpm',robot:1})">Robot 2</button></div></div>
