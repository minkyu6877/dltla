...
CARDS = (
    ("01_SMALL_A", "소형 화물 | 목적지 A", "SMALL / 1대", 4.0, 3.0, "SMALL_BOX", 2.0),
    ("02_LONG_A", "장형 화물 | 목적지 A", "LONG / 2대", 4.0, 3.0, "LONG_BOX", 8.0),
    ("03_SMALL_B", "소형 화물 | 목적지 B", "SMALL / 1대", 4.0, -0.5, "SMALL_BOX", 2.0),
    ("04_LONG_B", "장형 화물 | 목적지 B", "LONG / 2대", 4.0, -0.5, "LONG_BOX", 8.0),
)
